    ...
    <>
      ...
      <main>
        <section className='py-10 md:py-20 px-5 md:px-10 bg-primary'>
          ...
          <div className='mt-10 md:mt-20 max-w-5xl mx-auto bg-light rounded-2xl md:rounded-[3rem] p-5 md:p-10 text-primary'>
            ...
            <form className='w-full mt-10'>
              <h2 className='text-xl font-semibold leading-8'>Paste your long link here</h2>
              <input
                type='text'
              ...
              <button
                type='submit'
                className='bg-blue cursor-pointer text-light py-3 px-5 mt-5 rounded-lg font-semibold flex text-xl items-center justify-center transition-all duration-300 hover:bg-blue/80'
              >
